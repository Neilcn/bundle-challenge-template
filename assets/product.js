class ProductForm extends HTMLElement {
    ...
    connectedCallback() {
        const productForm = this.querySelector('.shopify-product-form');
        if (productForm) {
    ...
    handleFormSubmit(event) {
        ...
        const formItemId = this.querySelector('input[name="id"]').value;
        const bundleCard = this.querySelector('.bundle-product');
